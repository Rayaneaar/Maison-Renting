...
export default function Landing() {
  ...
  return (
    ...
    >
      {/* Global Navbar placed on top */}
      <div className="absolute top-0 w-full z-50">
        <Navbar />
      </div>

      {/* Split Hero Section */}
      <section className="relative w-full h-screen flex pt-[80px]">
        {/* Left Half - Solid Cream Background */}
        <div className="w-1/2 h-full bg-sand relative p-12 flex flex-col justify-end z-10">
          {/* Bottom Left Content (Optional, removing nav since we have a real top navbar now) */}
        ...
        {/* Center Overlapping Text */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
          {/* Subtle gradient overlay to ensure text legibility over the image half */}
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-sand/60 to-transparent pointer-events-none" />
          
          <div className="max-w-4xl text-center flex flex-col items-center text-zinc-900 relative z-30 pt-20">
            <motion.h1 
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 1, delay: 0.2 }}
              className="text-[4.5rem] lg:text-[7rem] font-medium leading-[0.95] tracking-tight mb-8 drop-shadow-sm"
            ...
            <motion.button 
              ...
              className="mt-4 pointer-events-auto bg-black text-white px-8 py-3.5 rounded-full text-sm font-medium hover:bg-zinc-800 transition-colors"
            >
              Start Exploring
            </motion.button>
          </div>
      ...
      <section className="py-24 px-6 lg:px-16 max-w-[1800px] mx-auto w-full bg-sand">
        <div className="flex justify-between items-end mb-12">
          <h2 className="text-3xl font-medium tracking-tight">Featured Properties</h2>
      ...
      {/* Extended Section: About / Value Prop */}
      <section className="py-24 px-6 lg:px-16 w-full bg-white border-t border-zinc-200">
        <div className="max-w-[1500px] mx-auto flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            <h2 className="text-4xl lg:text-5xl font-medium tracking-tight mb-8">Redefining luxury real estate.</h2>
          ...
          <div className="lg:w-1/2 aspect-[4/3] w-full bg-zinc-100 relative overflow-hidden">
